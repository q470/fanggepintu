...
- (void)viewDidLoad
{
    ...
    for (NSInteger i=0; i<8; i++) {
        ...
        CGRect fangkuaiweizhi = CGRectMake(x, y, 103, 67);
    ...
    [grayButton setFrame:CGRectMake(217, 260, 103, 67)];
...
#pragma mark - 设置方格
    ...
    for (NSInteger i=0; i<8; i++) {
        ...
        NSString *tupian = [NSString stringWithFormat:@"tupian9_%.2i",i+1];
...
- (void)xiayiguan
{
    [self dismissViewControllerAnimated:YES completion:^{
        ...
        dakaianniu.dishiguan.userInteractionEnabled = YES;
    }];
}
        ...
        for (i=0; i<8; i++) {
            ...
            if (CGRectEqualToRect(hedui.frame, hedui2)) {
                ...
                if (j==7) {
                    ...
                    UIButton *grayButton = (UIButton *)[self.view viewWithTag:9];
                    [grayButton setBackgroundImage:[UIImage imageNamed:@"tupian9_09.png"] forState:UIControlStateNormal];
...
- (void)chakanyuantu
{
    ...
    UIImageView *yuantu = [[UIImageView alloc] initWithFrame:CGRectMake(80, 152, 169, 101)];
    
    [yuantu setImage:[UIImage imageNamed:@"yuantu9.png"]];
