...
//  pintu2
//
//  Created by Administartor on 15-11-15.
...
#pragma mark - 设置方格
    ...
    for (NSInteger i=0; i<8; i++) {
        ...
        NSString *tupian = [NSString stringWithFormat:@"tupian3_%.2i.png",i+1];
...
- (void)xiayiguan
{
    [self dismissViewControllerAnimated:YES completion:^{
        ...
        dakaianniu.disiguan.userInteractionEnabled = YES;
    }];
}
        ...
        for (i=0; i<8; i++) {
            ...
            if (CGRectEqualToRect(hedui.frame, hedui2)) {
                ...
                if (j==7) {
                    ...
                    UIButton *grayButton = (UIButton *)[self.view viewWithTag:9];
                    [grayButton setBackgroundImage:[UIImage imageNamed:@"tupian3_09.png"] forState:UIControlStateNormal];
...
- (void)chakanyuantu
{
    ...
    [yuantu setImage:[UIImage imageNamed:@"yuantu3.jpg"]];
