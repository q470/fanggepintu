...
- (void)viewDidLoad
{
    ...
    for (NSInteger i=0; i<8; i++) {
        ...
        CGRect fangkuaiweizhi = CGRectMake(x, y, 83, 111);
    ...
    [grayButton setFrame:CGRectMake(199, 297, 83, 111)];
...
#pragma mark - 设置方格
    ...
    for (NSInteger i=0; i<8; i++) {
        ...
        NSString *tupian = [NSString stringWithFormat:@"tupian8_%.2i.png",i+1];
...
- (void)xiayiguan
{
    [self dismissViewControllerAnimated:YES completion:^{
        ...
        dakaianniu.dijiuguan.userInteractionEnabled = YES;
    }];
}
        ...
        for (i=0; i<8; i++) {
            ...
            if (CGRectEqualToRect(hedui.frame, hedui2)) {
                ...
                if (j==7) {
                    ...
                    UIButton *grayButton = (UIButton *)[self.view viewWithTag:9];
                    [grayButton setBackgroundImage:[UIImage imageNamed:@"tupian8_09.png"] forState:UIControlStateNormal];
...
- (void)chakanyuantu
{
    ...
    UIImageView *yuantu = [[UIImageView alloc] initWithFrame:CGRectMake(120, 140, 83, 111)];
    
    [yuantu setImage:[UIImage imageNamed:@"yuantu8.jpg"]];
