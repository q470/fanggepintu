...
////
////            [button setFrame:CGRectMake(7 + 105 * i, 83, 97, 97)];
////            
...
////            [button setBackgroundColor:[UIColor redColor]];
////            
////            [button setFrame:CGRectMake(7 + 105 * i, 188, 97, 97)];
////            
////            [self.view addSubview:button];
////        }
////        
...
////            [button setBackgroundColor:[UIColor redColor]];
////            
////            [button setFrame:CGRectMake(7 + 105 * i, 293, 97, 97)];
////            
////            [self.view addSubview:button];
////        }
////    }
...
//        
//        
//        [button setFrame:CGRectMake(x, y, 97, 97)];
//        
//        [self.view addSubview:button];
//    }
//    
...
#pragma mark - 设置方格
    ...
    for (NSInteger i=0; i<8; i++) {
        ...
        NSString *tupian = [NSString stringWithFormat:@"tupian2_%.2i.png",i+1];
        ...
        //        //成功调用下一关
        //
        //        disiguan *xian = [[disiguan alloc] init];
        //
        //        [xian xianshi];
    }
...
- (void)xiayiguan
{
    [self dismissViewControllerAnimated:YES completion:^{
        ...
        dakaianniu.disanguan.userInteractionEnabled = YES;
    }];
}
        ...
        for (i=0; i<8; i++) {
            ...
            if (CGRectEqualToRect(hedui.frame, hedui2)) {
                ...
                if (j==7) {
                    ...
                    UIButton *grayButton = (UIButton *)[self.view viewWithTag:9];
                    [grayButton setBackgroundImage:[UIImage imageNamed:@"tupian2_09.png"] forState:UIControlStateNormal];
...
//- (void)tachujieguo
//{
//    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"拼接成功" message:@"你赢啦！" delegate:nil cancelButtonTitle:@"Yeah" otherButtonTitles:nil];
//    
//    [alert show];
//}
...
- (void)chakanyuantu
{
    ...
    UIImageView *yuantu = [[UIImageView alloc] initWithFrame:CGRectMake(80, 152, 160, 126)];
    
    [yuantu setImage:[UIImage imageNamed:@"yuantu2.png"]];
