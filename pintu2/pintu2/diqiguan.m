...
- (void)viewDidLoad
{
    ...
    for (NSInteger i=0; i<8; i++) {
        ...
        CGRect fangkuaiweizhi = CGRectMake(x, y, 73, 98);
    ...
    [grayButton setFrame:CGRectMake(200, 293, 73, 98)];
...
#pragma mark - 设置方格
    ...
    for (NSInteger i=0; i<8; i++) {
        ...
        NSString *tupian = [NSString stringWithFormat:@"tupian7_%.2i.png",i+1];
...
- (void)xiayiguan
{
    [self dismissViewControllerAnimated:YES completion:^{
        ...
        dakaianniu.dibaguan.userInteractionEnabled = YES;
    }];
}
        ...
        for (i=0; i<8; i++) {
            ...
            if (CGRectEqualToRect(hedui.frame, hedui2)) {
                ...
                if (j==7) {
                    ...
                    UIButton *grayButton = (UIButton *)[self.view viewWithTag:9];
                    [grayButton setBackgroundImage:[UIImage imageNamed:@"tupian7_09.png"] forState:UIControlStateNormal];
...
- (void)chakanyuantu
{
    ...
    UIImageView *yuantu = [[UIImageView alloc] initWithFrame:CGRectMake(90, 120, 146, 196)];
    
    [yuantu setImage:[UIImage imageNamed:@"yuantu7.jpg"]];
