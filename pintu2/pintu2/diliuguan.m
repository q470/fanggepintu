...
- (void)viewDidLoad
{
    ...
    for (NSInteger i=0; i<8; i++) {
        ...
        CGRect fangkuaiweizhi = CGRectMake(x, y, 51, 90);
    ...
    [grayButton setFrame:CGRectMake(160, 280, 51, 90)];
...
#pragma mark - 设置方格
    ...
    for (NSInteger i=0; i<8; i++) {
        ...
        NSString *tupian = [NSString stringWithFormat:@"tupian6_%.2i.png",i+1];
...
- (void)xiayiguan
{
    [self dismissViewControllerAnimated:YES completion:^{
        ...
        dakaianniu.diqiguan.userInteractionEnabled = YES;
    }];
}
        ...
        for (i=0; i<8; i++) {
            ...
            if (CGRectEqualToRect(hedui.frame, hedui2)) {
                ...
                if (j==7) {
                    ...
                    UIButton *grayButton = (UIButton *)[self.view viewWithTag:9];
                    [grayButton setBackgroundImage:[UIImage imageNamed:@"tupian6_09.png"] forState:UIControlStateNormal];
...
- (void)chakanyuantu
{
    ...
    UIImageView *yuantu = [[UIImageView alloc] initWithFrame:CGRectMake(100, 140, 85, 151)];
    
    [yuantu setImage:[UIImage imageNamed:@"yuantu6.jpg"]];
